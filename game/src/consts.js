...
export const SERVE = { handZ: 1.55, handY: 0.16, tossV: 2.2, xMax: 0.9, offsetMax: 0.35, power: 0.5, spinSweep: 42, spinBrushMax: 5.2, botMinDepth: 0.85, reachZ: 1.2, maxSpeed: 7.5, maxSpin: 420, maxEl: 0.15, assist: { angle: 0.35, pace: 0.5, spin: 260, yaw: 0.12 } };   // a serve is never a smash: the launch is capped before the two-bounce assist   // a 20 cm toss; a serve is never a smash
...
export const LEVELS = {
  novice: { name: 'NOVICE', venue: 'gym', speed: 4.0, react: 0.2, sigma: 0.34, sigmaTheta: 0.06, spd: [4.3, 6.2], spin: [0, 50], smash: false, letsOut: 0, whiff: 0.2, place: 'center', early: 0, serveSpd: [4.0, 4.8], serveSpin: 0, serveToPaddle: true, serveReach: 0.12, serveDepth: [0.9, 1.15], assist: 1.9, assistAngle: 0.45, assistSpin: 420, assistPace: 0.3, assistBoost: 2.4, magnet: 0.85, magnetR: 0.32, magnetMax: 0.16, swingHold: 0.2, autoSwing: true, approachSlow: 0.25, assistYaw: 0.16, wrist: 0.75, slow: 0.8, aim: true },
  rookie: { name: 'ROOKIE', venue: 'hall', speed: 5.0, react: 0.15, sigma: 0.3, sigmaTheta: 0.05, spd: [5.0, 7.5], spin: [0, 120], smash: false, letsOut: 0, whiff: 0.14, place: 'center', early: 0, serveSpd: [4.6, 5.8], serveSpin: 0, serveToPaddle: true, serveReach: 0.25, serveDepth: [0.9, 1.18], assist: 1.75, assistAngle: 0.4, assistSpin: 420, assistPace: 0.4, assistBoost: 2.0, magnet: 0.75, magnetR: 0.28, magnetMax: 0.13, swingHold: 0.16, autoSwing: true, approachSlow: 0.2, assistYaw: 0.13, wrist: 0.65, slow: 0.86, aim: true },
  club: { name: 'CLUB', venue: 'club', speed: 6.2, react: 0.13, sigma: 0.15, sigmaTheta: 0.028, spd: [8, 14], spin: [140, 380], smash: true, letsOut: 0.25, whiff: 0.05, place: 'corners', early: 0.15, serveSpd: [6, 8], serveSpin: 120, serveToPaddle: false, serveReach: 0.45, serveDepth: [0.88, 1.2], assist: 1.45, assistAngle: 0.4, assistSpin: 420, assistPace: 0.4, assistBoost: 2.0, magnet: 0.75, magnetR: 0.28, magnetMax: 0.13, swingHold: 0.16, autoSwing: true, approachSlow: 0.2, assistYaw: 0.13, wrist: 0.45, slow: 0.94, aim: true },
  pro: { name: 'PRO', venue: 'arena', speed: 8.5, react: 0.07, sigma: 0.06, sigmaTheta: 0.012, spd: [12, 22], spin: [350, 700], smash: true, letsOut: 1, whiff: 0.012, place: 'away', early: 0.45, serveSpd: [7, 10], serveSpin: 280, serveToPaddle: false, serveReach: 0.55, serveDepth: [0.85, 1.22], assist: 1.2, assistAngle: 0.32, assistSpin: 300, assistPace: 0.5, assistBoost: 1.6, magnet: 0.6, magnetR: 0.24, magnetMax: 0.1, swingHold: 0.12, autoSwing: true, approachSlow: 0.15, assistYaw: 0.1, wrist: 0.3, slow: 1.0, aim: true},
};
